    ...
    return (
        <>
            ...
            <Container className="text-center">
                 <h2 variant="danger" style={{fontSize:"40px", fontFamily:'"Hammersmith One", sans-serif'}} className="d-block d-md-none">THINGS ON US</h2>
                 <h2 variant="danger" style={{fontSize:"50px", fontFamily:'"Hammersmith One", sans-serif'}} className="d-none d-md-block">THINGS ON US</h2>
