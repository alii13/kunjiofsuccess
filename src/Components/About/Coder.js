      ...
      <Carousel activeIndex={index} onSelect={handleSelect} indicators={false}>
                <Carousel.Item>
                      <Row>
                          ...
                          <p style={{fontFamily:'"Metrophobic", sans-serif', fontSize:"18px"}} className="d-block d-md-none text-lg-left">I am  highly self motivated web developer who spends most of time building applications, Teaching Others and Loppinf myself upto date with latet technologies</p>
                          <p style={{fontFamily:'"Metrophobic", sans-serif', fontSize:"20px"}} className="d-none d-md-block text-justify">I am  highly self motivated web developer who spends most of time building applications, Teaching Others and Loppinf myself upto date with latet technologies</p>
